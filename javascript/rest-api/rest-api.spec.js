...
describe("Rest API", () => {
  ...
  describe("iou", () => {
    xxtest("both users have 0 balance", () => {
      const seedUsers = [
        { name: "Adam", owes: {}, owed_by: {}, balance: 0 },
        { name: "Bob", owes: {}, owed_by: {}, balance: 0 },
      ];
    ...
    xxtest("borrower has negative balance", () => {
      const seedUsers = [
        { name: "Adam", owes: {}, owed_by: {}, balance: 0 },
    ...
    xxtest("lender has negative balance", () => {
      const seedUsers = [
        { name: "Adam", owes: {}, owed_by: {}, balance: 0 },
        { name: "Bob", owes: { Chuck: 3 }, owed_by: {}, balance: -3 },
        { name: "Chuck", owes: {}, owed_by: { Bob: 3 }, balance: 3 },
    ...
    xxtest("lender owes borrower less than new loan", () => {
      const seedUsers = [
        { name: "Adam", owes: { Bob: 3 }, owed_by: {}, balance: -3 },
        { name: "Bob", owes: {}, owed_by: { Adam: 3 }, balance: 3 },
      ];
    ...
    xxtest("lender owes borrower same as new loan", () => {
      const seedUsers = [
        { name: "Adam", owes: { Bob: 3 }, owed_by: {}, balance: -3 },
        { name: "Bob", owes: {}, owed_by: { Adam: 3 }, balance: 3 },
      ];
